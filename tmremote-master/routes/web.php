...
// Public Legal pages
Route::get('legal/eula', 'LegalController@eula');
Route::get('legal/tos', 'LegalController@tos');
Route::get('legal/privacy-policy', 'LegalController@privacyPolicy');
Route::get('legal/disclaimer', 'LegalController@disclaimer');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('download', 'DownloadsController@index')->name('app.download');
    ...
    Route::get('active-users', [
        'as' => 'active-users',
        'uses' => 'ActiveUsersController@index',
    ]);
