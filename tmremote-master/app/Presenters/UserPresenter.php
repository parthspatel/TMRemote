...
class UserPresenter extends Presenter
{
    ...
    {
        return trim($this->entity->username) ?: $this->entity->email;
    ...
    public function avatar()
    {
        ...
        return Str::contains($this->entity->avatar, ['http', 'gravatar']) ? $this->entity->avatar : url("upload/users/{$this->entity->avatar}");
    }

    public function birthday()
    {
        return $this->entity->birthday ? $this->entity->birthday->format(config('app.date_format')) : 'N/A';
    }
